			...
			<div class="sayilar">
				<?php
					for($i=0;$i<$toplamsayfa;$i++){
						if($i == $suankisayfa){
						?>
						<a class="aktif" href="<?php echo get::site(); ?>/BlogTest/Tag/<?php echo $Tags; ?>/<?php echo $i; ?>"><?php echo $i+1; ?></a>
						<?php
						}
						else{
						?>
						<a href="<?php echo get::site(); ?>/BlogTest/Tag/<?php echo $Tags; ?>/<?php echo $i; ?>"><?php echo $i+1; ?></a>
						<?php
						}
					}
				?>
